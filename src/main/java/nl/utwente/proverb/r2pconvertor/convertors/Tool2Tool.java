package nl.utwente.proverb.r2pconvertor.convertors;

import lombok.Getter;
import nl.utwente.proverb.r2pconvertor.mdwriters.ToolMDWriter;
import nl.utwente.proverb.r2pconvertor.service.OntologyService;
import nl.utwente.proverb.r2pconvertor.service.OntologyServiceImpl;
import org.apache.jena.rdf.model.Resource;

import java.io.File;

public class Tool2Tool implements Convertor{
    ...
    private Tool2Tool(Builder builder){
        this.ontologyService = new OntologyServiceImpl(builder.modelFile);
